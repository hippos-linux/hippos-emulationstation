...
{	
...
#ifdef HIPPOS
	LOG(LogInfo) << "HIPPOS is defined";
#else
	LOG(LogInfo) << "HIPPOS is NOT defined";
#endif
	...
	mMusicPath = "/usr/share/hippos/music";
	...
	mDecorationsPath = "/usr/share/hippos/datainit/decorations";
	mUserDecorationsPath = "/userdata/decorations";
	mShadersPath = "/usr/share/hippos/shaders/configs";
	...
	mSystemConfFilePath = "/userdata/system/hippos.conf";
	mUserManualPath = "/usr/share/hippos/doc/notice.pdf";
	mVersionInfoPath = "/usr/share/hippos/hippos.version";
