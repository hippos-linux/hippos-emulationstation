...
class GuiHippOSStoreEntry : public ComponentGrid
{
public:
	GuiHippOSStoreEntry(Window* window, PacmanPackage& entry, bool withPreviewImage);
...
class GuiHippOSStore : public GuiComponent, IContentInstalledNotify
{
public:
	GuiHippOSStore(Window* window);
	~GuiHippOSStore();
